...
My first pass at making a map like this was using [Multi-Dimensional Scaling](https://en.wikipedia.org/wiki/Multidimensional_scaling). Using this algorithm gives something like this (up to a random seed)
